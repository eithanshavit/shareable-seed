...
const VERSION_V1_ENTROPY_HEX_LENGTH = 64
...
function extractEntropyHex (shareableCode) {
  ...
  switch (versionHex) {
    case versionCodes.v1:
      ...
      const offset = VERSION_V1_ENTROPY_HEX_OFFSET + entropyLength
      return shareableCode.slice(offset, offset + VERSION_V1_ENTROPY_HEX_LENGTH - entropyLength)
    default:
      throw new Error(errors.INVALID_SHAREABLE_CODE_VERSION)
  }
}
