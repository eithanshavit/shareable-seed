...
const INVALID_SHARE_COUNT = 'Invalid share count'
const INVALID_SHARE_LIST = 'Invalid share list'

module.exports = {
  INVALID_MNEMONIC,
  INVALID_THRESHOLD,
  INVALID_WORDLIST_NAME,
  INVALID_WORDLIST_CODE,
  INVALID_SHAREABLE_CODE_VERSION,
  INVALID_SHAREABLE_CODE_CHECKSUM,
  INVALID_SHARE_COUNT,
  INVALID_SHARE_LIST
}
